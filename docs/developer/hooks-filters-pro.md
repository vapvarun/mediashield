...
> Free fires `mediashield_can_watch` at priority 10. Pro stacks at 20 (role) and 25 (LMS). Any custom callback should pick a priority outside that band, or accept that Pro's gates may have already returned a denied result.
